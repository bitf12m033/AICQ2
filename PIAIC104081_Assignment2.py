...
def function2():
    ...
    x =  np.arange(10,37,dtype='float').reshape(3,3,3)   #wrtie your code here
...
def function6():
    ...
    arr = np.zeros((2, 5), dtype=int)#wrtie your code here
    arr[1][0] = 10
    arr[1][3] = 20
    return arr
...
def function14():
    ...
    arr = numpy.arange(10, 34, 1).reshape() #write reshape code
...
def fucntion20():
    ...
    return np.vectorize(xyz, otypes=[int])(x) #Write your Code here
